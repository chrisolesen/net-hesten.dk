...
<section>
	...
	<div id="rules" style="max-width: 600px;margin: 0 auto;">
		...
		<h2>Gældende siden 24. Maj 2018</h2>
		<h2>
			Oversigt
		</h2>
		<h3>
		...
		<h3>
			Hvordan / hvorfor bruger vi de data vi har på dig
		</h3>
		<ul>
		...
		<ul>
			...
			<li><a href="#mother_company">PraktiskWeb</a></li>
			<li><a href="#partner">Samarbejdspartner / Medejer</a></li>
			<li><a href="#police">Politiet</a></li>
			<li><a href="#share_facebook">Facebook</a></li>
		</ul>
		<h3>
			! Særligt om det <span style="text-decoration: underline;font-family:inherit;">uofficielle</span> forum !
		</h3>
		<ul>
			<li><a href="#unofficial">Uofficielt betyder Uofficielt</a></li>
		</ul>
		...
		<!--<p>Data der kan bruges til migration, er vedhæftet som en ".json" fil, når du <a href="#access">anmoder om data adgang</a>.</p>-->
		<!--<p>Den json fil, er fuldt kompatibel med integration i andre systemer.</p>-->
		...
		<h2 id="mother_company">PraktiskWeb</h2>
		<p>Det giver lidt sig selv, at PraktiskWeb (cvr: 37871613) værende den officielle ejer af sitet, har ubeskåret adgang til alle oplysninger.</p>
		<p>Men for at der ikke skal være nogen anledning til tvivl, så nævner vi det lige alligevel.</p>
		<p>PraktiskWeb er et PMV der drives af Chris Olesen:<br /> &bullet;&nbsp;<a href="https://www.facebook.com/chris.olesen1">Facebook</a> &bullet;&nbsp;<a href="https://www.linkedin.com/in/chrisolesen1/">LinkedIN</a></p>
		<h2 id="partner">Samarbejdspartner / Medejer</h2>
		<p>Stutteri Net-Hesten styres af Line Jensen:<br /> &bullet;&nbsp;<a href="https://www.facebook.com/LineBineBone">Facebook</a></p>
		<p>Line har ikke en direkte association med PraktiskWeb, men ejer i henhold til aftale med PraktiskWeb 50% af de immaterielle rettigheder relateret til net-hesten.dk</p>
		<p>Hun har ikke direkte data adgang, men har som admin i spillet, adgang til specifikt udvalgte data via admin paneler, stillet til rådighed af PraktiskWeb</p>
		<p>Der er kun adgang til konkret nødvendige oplysninger, i forbindelse med at sikre spillets drift</p>
		<p>Af hensyn til spillets omskiftelige natur, bør det dog antages, og dermed accepteres, at Line har adgang til alt data nævnt i punktet <a href="#what_data">Hvilke data har vi på dig</a></p>
		...
		<h2 id="share_facebook">Fackbook</h2>
		...
		<h1>! Særligt om det <span style="text-decoration: underline;font-family:inherit;">uofficielle</span> forum !</h1>
		<h2 id="unofficial">Uofficielt betyder Uofficielt</h2>
		<p>Dette vil sige, at selvom vi har en bruger på forummet, og vi også linker dertil, så er det drevet af en af net-hestens brugere.</p>
		<p>Fox har været så flink, at opsætte et sted, til de af jer der ønskede det, kunne chatte i bedre format, end chatten.</p>
		<p>Grundet den umiddelbare popularitet af forummet, fremfor chatten, har vi valgt at være tilstede der, og bruge de muligeder der er.</p>
		<p>Men Net-Hestens data politik, ombefatter altså IKKE forummet, vi håber på at være klar med et officielt forum inden 2019.</p>
		<p>Forummet er i det hele taget, ikke rigtig dækket af GDPR som sådan, da det officielt set, bare er en privat person der har oprettet et gratis chat board.</p>
		<p>Vi har dog muligheder for, at være behjælpelige med, at I kan blive slettet derfra, såfremt det skulle blive aktuelt</p>
		<p>Vi sørger også for, efter vores bedste evne, at alt data bliver ryddet derfra, når vi engang er klar med et officelt forum.</p>
		<br />
		<br />
		<br />
	</div>

...
<link href="https://files.<?= filter_input(INPUT_SERVER,'HTTP_HOST');?>/scripts/booklet/jquery.booklet.latest.css" type="text/css" rel="stylesheet" media="screen, projection, tv">
<script src="https://files.<?= filter_input(INPUT_SERVER,'HTTP_HOST');?>/scripts/booklet/jquery.booklet.latest.min.js"></script>
<section>

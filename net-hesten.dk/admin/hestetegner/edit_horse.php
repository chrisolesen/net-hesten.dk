		...
		<form method="post" action="">
			...
			?>
				...
				<span>Køn:</span><select name="gender">
					...
					<option value='stallion' <?= ($gender == 'hingst' ? 'selected' : ''); ?>>Hingst</option>
					<option value='mare' <?= ($gender == 'hoppe' ? 'selected' : ''); ?>>Hoppe</option>
				</select><br />
				<span>Status:</span><select name="status">
					<option value='no-status'>Ingen status angivet</option>
					<option value='død' <?= ($status == 'død' ? 'selected' : ''); ?>>Død</option>
					<option value='føl' <?= ($status == 'føl' ? 'selected' : ''); ?>>Føl</option>
					<option value='hest' <?= ($status == 'hest' ? 'selected' : ''); ?>>Hest</option>
					<option value='avl' <?= ($status == 'avl' ? 'selected' : ''); ?>>Avl</option>
				</select>
				<br />
			<?php
			}

...
?>
<script src="//<?= filter_input(INPUT_SERVER, 'HTTP_HOST'); ?>/scripts/tinymce/tinymce.min.js"></script>
<script>
	tinymce.init({
...
<section>
	...
	<header>
		<h2 class="raised">Indsendte heste</h2>
	</header>
	<table>
		<thead>
			<td>Billed</td>
		...
		?>
			<tr <?= $style; ?>>
				<td>
					<div><img height="200px" src="//files.<?= HTTP_HOST; ?>/horses/artist_submissions/<?= $submission['image']; ?>" /></div>
				</td>

...
<section class="tabs">
	<div class="grid">
		...
		?>
			<div class="drawing">
				<img style="float:left;margin-right:20px;" src="//<?= filter_input(INPUT_SERVER, 'HTTP_HOST'); ?>//files.net-hesten.dk/imgHorse/<?= $link_new->query("SELECT image FROM `{$GLOBALS['DB_NAME_NEW']}`.horse_types WHERE id = {$competion_subdata->prize_id}")->fetch_object()->image; ?>" />

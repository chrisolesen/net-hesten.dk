<section id="left_menu">
	<?php if ($_SESSION['logged_in'] == true) { ?>
		...
		<a data-custom-title="Konkurrencer" href="/area/world/competition"><img src="https://files.<?= HTTP_HOST; ?>/graphics/competition.png"></a>
		<a data-custom-title="Søg på heste" href="/area/world/search/"><img src="https://files.<?= HTTP_HOST; ?>/graphics/list.png"></a>
		<a data-custom-title="Alle stutterier" href="/area/world/visit/"><img src="https://files.<?= HTTP_HOST; ?>/graphics/list.png"></a>
		<a data-custom-title="Hestetegner" href="/area/artist_center"><img src="https://files.<?= HTTP_HOST; ?>/graphics/artist.png"></a>
		<a data-custom-title="Privat handel" href="/area/world/privat_trade/"><img src="https://files.<?= HTTP_HOST; ?>/graphics/private_trade.png"></a>
		<a data-custom-title="Konto oversigt" href="/area/stud/accounting"><img src="https://files.<?= HTTP_HOST; ?>/graphics/money.png"></a>
		<a data-custom-title="Støt net-hesten" href="/area/world/support_nethesten/"><img src="https://files.<?= HTTP_HOST; ?>/graphics/buy_wkr.png"></a>
		...
		<?php if (in_array('tech_admin', $_SESSION['rights'])) { ?>
			...
			<a <?php if (!$partaking->fetch_object()) {
					echo 'message_status=""';
				} ?> data-custom-title="Lodtrækning" href="/area/world/simple_competition/"><img src="https://files.<?= HTTP_HOST; ?>/graphics/simple_competition.png"></a>
			<a data-custom-title="Vær din hest"><img src="https://files.<?= HTTP_HOST; ?>/graphics/be_your_horse.png"></a>
			<a><img src="https://files.<?= HTTP_HOST; ?>/graphics/house.png"></a>
			<a><img src="https://files.<?= HTTP_HOST; ?>/graphics/lotto.png"></a>
		<?php } ?>
		...
		<?php if (in_array('global_admin', $_SESSION['rights']) || in_array('admin_panel_access', $_SESSION['rights']) || in_array('site_helper', $_SESSION['rights'])) {	?>
			<a data-custom-title="Admin" href="/admin/"><img src="https://files.<?= HTTP_HOST; ?>/graphics/admin.png"></a>
		<?php } ?>
	<?php } ?>
</section>
<section id="left_menu" class="<?= $_SESSION['settings']['left_menu_style'] ??= 'mode_default' ?>">
	<?php if (($_SESSION['logged_in'] ?? false) == true) { ?>
		...
		<a data-custom-title="Uofficielt Forum" href="https://net-hesten.freeforums.net/" target="_BLANK"><img height="55" width="55" src="//files.<?= HTTP_HOST; ?>/graphics/forum.png"></a>

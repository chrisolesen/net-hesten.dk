<div id="horze_extended_info" class="modal"><?php /* */ ?>
	<script>
		function horze_extended_info(caller) {
			jQuery.getJSON({
				...
				jQuery('#horze_extended_info .thumb').attr('src', horse_data.thumb);
				console.log(horse_data.thumb);
	...
	<style>
		...
		#horze_extended_info .content {
			display: grid;
			grid-gap: 1em;
			grid-template-columns: 250px 1fr;
		}

		#horze_extended_info .content h2 {
			grid-column-start: 1;
			grid-column-end: 3;
			grid-row: 1;
		}

		#horze_extended_info .content .foil_info {
			grid-column: 2;
			grid-row: 2;
		}

		#horze_extended_info .content .foil_info .label {
			width: 60px;
		}

		#horze_extended_info .content .attribute_list {
			grid-column: 1;
			grid-row: 2;
		}
	</style>
